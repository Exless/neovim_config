...
_G.packer_plugins = {
  LuaSnip = {
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/LuaSnip",
    url = "https://github.com/L3MON4D3/LuaSnip"
  },
  ["cmp-nvim-lsp"] = {
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp",
    url = "https://github.com/hrsh7th/cmp-nvim-lsp"
  },
  harpoon = {
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/harpoon",
    url = "https://github.com/ThePrimeagen/harpoon"
  },
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
    url = "https://github.com/VonHeikemen/lsp-zero.nvim"
  },
  ["mason-lspconfig.nvim"] = {
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/mason-lspconfig.nvim",
    url = "https://github.com/williamboman/mason-lspconfig.nvim"
  },
  ["mason.nvim"] = {
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/mason.nvim",
  ...
  ["nvim-dap"] = {
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/nvim-dap",
    url = "https://github.com/mfussenegger/nvim-dap"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/nvim-lspconfig",
  ...
  ["rose-pine"] = {
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  ["toggleterm.nvim"] = {
    ...
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
    url = "https://github.com/akinsho/toggleterm.nvim"
  },
  undotree = {
    loaded = true,
    path = "/home/vlad/.local/share/nvim/site/pack/packer/start/undotree",
